                    ...
                    for s in u.steps.filter(is_active=True):
                        ...
                        for p in s.parameters.filter(is_active=True):
                            Parameter.objects.create(
                                ...
                                format_lower_range=p.format_lower_range,
                                format_upper_range=p.format_upper_range,
                                lower_proven_acceptable_range=p.lower_proven_acceptable_range,
                                upper_proven_acceptable_range=p.upper_proven_acceptable_range,
                                lower_normal_operating_range=p.lower_normal_operating_range,
                                upper_normal_operating_range=p.upper_normal_operating_range,
                                order=p.order,
                                created_by=request.user,
                                updated_by=request.user,
                            )
